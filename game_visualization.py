# script to visualize how PyToch DQL agent plays a game
...
iteration_list = [1424000,1995000]
...
for iteration in iteration_list:
    ...
    for i in range(5):
        visualize_game(env, agent,
            path='images/game_visual_{:s}_{:d}_no_ob_{:d}.mp4'.format(version, iteration, i),
